...
- Unit testing
- Exception handling
- Web programming (brief introduction)
...
- [x] Week 2 – Functions and Arguments
- [x] Week 3 – Exceptions and File I/O
- [x] Week 4 – Libraries
- [x] Week 5 – Unit Testing
- [x] Week 6 – File Handling and Regular Expressions
...
- Understand core programming logic and syntax using Python
- Build real-world, terminal-based applications
